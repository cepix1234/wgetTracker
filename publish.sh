...
cp ./app/cepix1234.WgetTracker.App/appsettings.json "${ReleaseWinPath}/appsettings.json"
cp ./app/cepix1234.WgetTracker.App/appsettings.json "${ReleaseLinuxPath}/appsettings.json"
cp ./app/cepix1234.WgetTracker.App/appsettings.json "${ReleaseLinuxArmPath}/appsettings.json"
